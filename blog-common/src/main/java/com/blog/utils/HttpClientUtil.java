...
/**
 * @ClassName: HttpClientUtil @Description: TODO
 *
 * @author Mundo
 */
public class HttpClientUtil {
   ...
   * @author Mundo
   */
  public static String doGetGBK(String url, Map<String, String> params) {
  ...
  /**
   * @Title: doPost @Description: post请求
   *
   * @param url
   * @param params
   * @return
  ...
  /**
   * @Title: sendJsonStr @Description: post发送json字符串
   *
   * @param url
   * @param params
   * @return 返回数据
